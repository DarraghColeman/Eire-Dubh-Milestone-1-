...
I want to learn about larger global history surrounding this site's theme.
...
Instructions on how to implement the general site elements was taken from CodeInstitute's tutorials.
Instructions on how to implement the media queries, color gradients, transitions and other methods was taken from W3schools.org. 
Instructions on how to implement the navbar was taken from
Instructions on how to implement the responsive layout and utility classes was taken from 
Instructions on how to implement the animated cards section was taken from Specific YouTube Tutorial

Instructions on how to implement the footer was taken from 
Instructions on how to implement the 'Contact' page layout and form was taken from 
